...
const int dhtPin = 14;
const int MQgasSensorPin = A4;   // MQ-135 gas sensor connected to Analog Pin 4.
...
void setup() {
  ...
  chipid=ESP.getEfuseMac();                  // Get MAC address and print the High 2 byes and low 4 bytes
